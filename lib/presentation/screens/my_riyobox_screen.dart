...
class MyRiyoboxScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionHeader('MY WATCHLIST', onTap: null),
            ...
            FutureBuilder<List<Movie>>(
              ...
              builder: (context, snapshot) {
                ...
                if (movies.isEmpty) return const Center(child: Text('Your list is empty', style: TextStyle(color: Colors.white54)));
                return _buildMovieHorizontalList(context, movies);
              },
            ),
            const SizedBox(height: 40),
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: const Text(
            'PREMIUM MEMBER',
            style: TextStyle(color: Colors.deepPurpleAccent, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.1),
          ),
        ),
      ],
    );
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final poster = movie.posterPath.startsWith('http') ? movie.posterPath : 'https://image.tmdb.org/t/p/w500${movie.posterPath}';
          return GestureDetector(
            onTap: () {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) =>
                            Container(color: const Color(0xFF262626), child: const Icon(Icons.movie, color: Colors.white10)),
                      ),
                    ),
                  ),
                  const SizedBox(height: 8),
                  ...
                  const SizedBox(height: 4),
                  Text('${movie.releaseDate.split('-')[0]} | ${movie.genres?.first ?? "N/A"}',
  ...
  Widget _buildAccountSettings(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        if (auth.role == 'admin') const SizedBox(height: 8),
        _buildSettingsButton(
          context,
  ...
  Widget _buildFooter() {
    return Column(
      children: const [
        Text('RIYOBOX PREMIUM V2.4.0',
            style: TextStyle(color: Colors.white24, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1.1)),
        SizedBox(height: 4),
        Text('CLOUD ID: 9L6K4D38',
            style: TextStyle(color: Colors.white24, fontSize: 10, letterSpacing: 1.1)),
      ],
    );
  }
}
